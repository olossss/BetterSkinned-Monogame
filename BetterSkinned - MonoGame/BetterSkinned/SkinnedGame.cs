...
namespace BetterSkinned
{
	...
	public class SkinnedGame : Microsoft.Xna.Framework.Game
	{
		...
		public SkinnedGame()
		{
			...
			camera = new Camera_Aux(graphics);
		...
		protected override void LoadContent()
		{
			...
			model = new AnimatedModel("t-pose_3");//Victoria-hat-dance");//Victoria-hat-tpose");
			model.LoadContent(Content);

			// Load the model that has an animation clip it in
			dance = new AnimatedModel("walk");//Victoria-hat-dance");
		...
		protected override void Draw(GameTime gameTime)
		{
			...
			model.Draw(graphics.GraphicsDevice, camera.View, camera.Projection, Matrix.Identity);
